...
class MBFRFull(MiraBest_F):
    ...
    """
    Child class to load all FRI (0), FRII (1) and Hybrid (2)
    [100, 102, 104, 110, 112], [200, 201, 210] and [300, 310]
    """
...
class MBFRConfidentNoHybrids(MiraBest_F):

    """
    Child class to load only confident FRI (0), FRII (1) sources
    [100, 102, 104], [200, 201], and [300]
    """
